...
```{r}
raw_data <-read.csv("data/merged_df_final.csv",check.names = FALSE)
raw_data
```
...
df_to_transform <- read.csv('data/name_changed.csv')
...
df_trans <- read.csv("data/final_full_name.csv")
...
```{r}
write.csv(train_1m, "1 Month/train_1m.csv", row.names = FALSE)
write.csv(train_3m, "3 Month/train_3m.csv", row.names = FALSE)
write.csv(train_6m, "6 Month/train_6m.csv", row.names = FALSE)
write.csv(train_12m, "12 Month/train_12m.csv", row.names = FALSE)

write.csv(test_1m, "1 Month/test_1m.csv", row.names = FALSE)
write.csv(test_3m, "3 Month/test_3m.csv", row.names = FALSE)
write.csv(test_6m, "6 Month/test_6m.csv", row.names = FALSE)
write.csv(test_12m, "12 Month/test_12m.csv", row.names = FALSE)

write.csv(final_df_1m, "1 Month/final_df_1m.csv", row.names = FALSE)
write.csv(final_df_3m, "3 Month/final_df_3m.csv", row.names = FALSE)
write.csv(final_df_6m, "6 Month/final_df_6m.csv", row.names = FALSE)
write.csv(final_df_12m, "12 Month/final_df_12m.csv", row.names = FALSE)
